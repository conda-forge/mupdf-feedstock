...
Once the `conda-forge` channel has been enabled, `mupdf` can be installed with:

```
conda install mupdf
```

It is possible to list all of the versions of `mupdf` available on your platform with:
